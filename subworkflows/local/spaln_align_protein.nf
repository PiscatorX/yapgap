...
workflow SPALN_ALIGN_PROTEIN {
    ...
    main:
       ...
       GAAS_FASTACLEANER(create_fasta_channel(proteins))

       FILTER_PROTEIN(GAAS_FASTACLEANER.out.fasta)
       
       EXONERATE_FASTACLEAN(FILTER_PROTEIN.out.clean_fasta)
       
       GAAS_FASTAFILTERBYSIZE(EXONERATE_FASTACLEAN.out.fasta, params.min_prot_length)
